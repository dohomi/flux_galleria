...
class Tx_FluxGalleria_ViewHelpers_PageRenderer_IncludeJsOptionsViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('optionName', 'string', 'Name of inline block', FALSE, 'myOptions');
