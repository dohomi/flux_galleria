# -*- coding: utf-8 -*-
#
# flux_galleria documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 25 Oct 2014 10:27:33 +0200.
#
...
htmlhelp_basename = 'flux_galleriadoc'
...
latex_documents = [
    ('Index', 'flux_galleria.tex', u'flux_galleria',
     u'###AUTHOR###', 'manual'),
]
...
pdf_documents = [
    ('Index', 'flux_galleria', u'flux_galleria',
     u'###AUTHOR###'),
]
...
texinfo_documents = [
    ('Index', 'flux_galleria', u'flux_galleria',
     u'###AUTHOR###', 'flux_galleria', 'One line description of project.',
     'Miscellaneous'),
]
